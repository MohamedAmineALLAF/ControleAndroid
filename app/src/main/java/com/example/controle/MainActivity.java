...
import com.example.controle.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nbrEuro = findViewById(R.id.txtEuro);
        btnEuro = findViewById(R.id.btnConv);
        résultat = findViewById(R.id.res);
